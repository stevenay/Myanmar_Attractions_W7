...
public class ViewPodLoginUser extends RelativeLayout
        implements ViewController<ViewPodLoginUser.LoginUserController> {
    ...
    private LoginUserController mController;
    ...
    @Override
    public void setController(LoginUserController controller) {
