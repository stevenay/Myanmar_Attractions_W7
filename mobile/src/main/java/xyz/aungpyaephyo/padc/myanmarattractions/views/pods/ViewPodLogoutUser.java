 ...
 */
public class ViewPodLogoutUser extends RelativeLayout
        implements ViewController<ViewPodLogoutUser.LogoutUserController> {
    ...
    @Override
    public void setController(LogoutUserController controller) {
        mController = controller;
    }

    interface LogoutUserController {
        void onTapLogin();
        void onTapRegister();
    }
}