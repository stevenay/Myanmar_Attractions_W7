...
public class ViewPodAccountControl extends FrameLayout
        implements ViewController<ViewPodAccountControl.UserInterface> {
    ...
    public void setController(UserInterface userController)
    {
    ...
    public interface UserInterface extends ViewPodLoginUser.LoginUserController, ViewPodLogoutUser.LogoutUserController
    {}
}